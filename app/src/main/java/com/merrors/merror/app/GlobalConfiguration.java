...
import com.merrors.merror.BuildConfig;
import com.merrors.merror.R;
import com.merrors.merror.mvp.model.api.Api;
...
//                MultiDex.install(base);  //这里比 onCreate 先执行,常用于 MultiDex 初始化,插件化框架的初始化
            ...
            public void onCreate(Application application) {
                ...
                RxSocialConnect.register(application, "mMerroryEncryptionKey").using(new GsonSpeaker());
